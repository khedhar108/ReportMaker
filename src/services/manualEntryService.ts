...
5.  **Generate Remarks (CRITICAL: 70/30 Rule)**: Write a comprehensive qualitative overview (minimum 3 full sentences) strictly following the **70/30 Rule**:
    ...
    - **Tone**: Diagnostic and constructive. Do not sugarcoat low performance; treat this as a performance review that prioritizes growth through identifying weaknesses. Do not mention specific scores, but describe the performance levels qualitatively.
